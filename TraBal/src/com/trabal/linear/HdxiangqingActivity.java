...
public class HdxiangqingActivity extends Activity{
	...
	private TextView type,title,host_user,hotspot,time,telephone,introduction,hs_name;
	
	private ImageView pic1,pic2,pic3,pic4,host_usr_pic,w1,w2,w3,w4,all_w,hs1,hs2,hs3,hs4;
		...
		back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if("collect".equals(from)){
					Intent intent=new Intent(HdxiangqingActivity.this,collectActivity.class);
					...
					Intent intent=new Intent(HdxiangqingActivity.this,MainActivity.class);
		...
		public void onClick(View arg0) {
			...
			try {
				...
				if ("success_favour".equals(nt.getStatus())) {
					...
					whowanttogo.add(new BasicNameValuePair("act_id",ab.getId()));
					whowanttogo.add(new BasicNameValuePair("action", "detail"));
					String ajax_url = "activity/base";
					String ajax_data = NetTransfer.transfer(ajax_url, "get", whowanttogo, true,
							user.getAccess_token(), null);
