...
public class Hyxiangqingye extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		last_intent = Hyxiangqingye.this.getIntent();
		user = (UserBean) last_intent.getSerializableExtra("user");

	/*	hxb = (ArrayList<EvaluationBean>) last_intent
				.getSerializableExtra("hxb");

		for (EvaluationBean item : hxb) {
			item.getMood();
			item.getPrice();
			item.getUser();
		}*/
		...
		headerView = LayoutInflater.from(Hyxiangqingye.this).inflate(
	...
	class CustomAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView,
			...
			// 获取布局文件
			View view = View.inflate(Hyxiangqingye.this,
